...
<div class="album disbox-flex disbox-hor">
    <ul class="disbox-hor" id="photo_list" style="width: 100%;">
        ...
        <li class="disbox-flex disbox-center" style="transform: translateX(0%);">
            <img data-id="<?php  echo $t['id'];?>" data-ismain="false" <?php  if($t['type']==1) { ?> data-cansetmain="true" <?php  } else { ?> data-cansetmain="false" <?php  } ?> <?php  if($t['type']==0 ) { ?> data-checking="true" <?php  } else { ?> data-checking="false" <?php  } ?> src="<?php  echo tomedia($t['thumb'])?>">
        </li>
        <?php  } } ?>
...
<input type="hidden"  <?php  if(empty($i)) { ?> value="0" <?php  } else { ?> value="<?php  echo $i;?>" <?php  } ?> id="photo_index">
</body>
